...
def load_network(filepath, device):
    checkpoint = torch.load(filepath, map_location=device) #G:\Udacity_Save\
...
def process_image_easy(image):
    ...
    image_T = my_transforms(image) #.float()
...
def process_image_usePIL(image):
    ''' Scales, crops, and normalizes a PIL image for a PyTorch model,
        returns an Numpy array
    '''
    # TODO: Process a PIL image for use in a PyTorch model
...
def main():
    ...
    with torch.no_grad():
        ...
        #image_T = image_T.unsqueeze_(0)
        myinput_np = process_image_usePIL(image) #DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! 
        print('Numpy', myinput_np.shape)
        myinput_np = np.reshape(myinput_np, (1, 3, 224, 224)) 
        myinput = torch.FloatTensor(myinput_np) #DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! 
        #myinput = myinput.unsqueeze_(0) #DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! DEBUG! 
        print('Tensor:', myinput.shape)
        myoutput = model(myinput.to(in_args.device)) #process_image(image) #model(image_T)
